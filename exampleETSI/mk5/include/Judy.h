...
extern PPvoid_t JudyHSGet(       Pcvoid_t,  const void *, Word_t);
extern PPvoid_t JudyHSIns(       PPvoid_t,  const void *, Word_t, P_JE);
extern int      JudyHSDel(       PPvoid_t,  const void *, Word_t, P_JE);
